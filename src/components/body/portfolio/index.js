...
const aDevelopersFriendProps = {
  name: 'aDevelopersFriend',
  type: 'Full-Stack',
  languages: 'HTML - CSS - Javascript - React - MongoDB',
  website: 'https://adevelopersfriend.herokuapp.com/',
  github: 'https://github.com/SamuelHeal/a-DevelopersFriend',
  image: 'aDevelopersFriend',
};
  ...
  return (
    <div className='portfolioContainer'>
      ...
      <div className='container'>
        <Project props={aDevelopersFriendProps} />
